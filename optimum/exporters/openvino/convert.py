...
def export_pytorch(
    ...
    with torch.no_grad():
        ...
        ov_model.set_rt_info(gguf_params["gguf_version"], "lcp_gguf_version")
        ov_model.set_rt_info(gguf_params["kv"], "lcp_kv_params")
        ov_model.set_rt_info(gguf_params["kv_types"], "lcp_kv_types")
        ov_model.set_rt_info(gguf_params["kv_array_types"], "lcp_kv_array_types")
        ov_model.set_rt_info(gguf_params["tensor_name_map"], "lcp_tensor_name_map")
        ov_model.set_rt_info(gguf_params["tensor_shape_map"], "lcp_tensor_shape_map")
        ov_model.set_rt_info(gguf_params["tensor_type_map"], "lcp_tensor_type_map")
        ov_model.set_rt_info(gguf_params["transpose_permutations"], "lcp_transpose_permutations")
        ov_model.set_rt_info(gguf_params["expected_tensor_shapes"], "lcp_expected_tensor_shapes")
